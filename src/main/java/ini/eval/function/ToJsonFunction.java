...
public class ToJsonFunction extends BuiltInExecutable {

	public ToJsonFunction(IniParser parser) {
		super(parser, "to_json", "data");
	}

	@Override
	public void eval(IniEval eval) {
		eval.result = new RawData(getArgument(eval, 0).toJson());
	}
