...
public class ToIntFunction extends IniFunction {

	@Override
	public Data eval(IniEval eval, List<Expression> params) {
		return new RawData(eval.eval(params.get(0)).getNumber().intValue());
	}
	...
	public Type getType(IniParser parser,
		...
		return parser.types.createFunctionalType(parser.types.INT, t);
	}
